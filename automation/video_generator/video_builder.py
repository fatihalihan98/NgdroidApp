"""Combine downloaded clips and TTS audio into a single video (moviepy 2.x API)."""
...
def build_segment(
    ...
    *,
    ...
    video = VideoFileClip(str(clip_path)).without_audio()
...
def build_video(
    ...
    *,
    ...
    if background_music is not None:
        music = AudioFileClip(str(background_music)).subclipped(0, final.duration)
